    ...
    <div class="all">
        ...
        <div class="project">
            ...
            <swiper :modules="modules" :slides-per-view="1" :space-between="20" navigation
                ...
                <swiper-slide><img src="../assets/image23.png" alt=""></swiper-slide>
                <swiper-slide><img src="../assets/image24.png" alt=""></swiper-slide>
                <swiper-slide><img src="../assets/image25.png" alt=""></swiper-slide>
                <swiper-slide><img src="../assets/image26.png" alt=""></swiper-slide>
                <swiper-slide><img src="../assets/image27.png" alt=""></swiper-slide>
            </swiper>
            <div class="info">
                <div class="technologies"><i class='bx bxl-nodejs'></i><i class='bx bxl-html5'></i><i
                        class='bx bxl-css3'></i><i class='bx bxl-javascript'></i><i class="ex">EX</i></div>
                <p>The E-commerce project was a comprehensive design endeavor where I utilized Node.js, Express, HTML5, and CSS3 to develop a user-friendly football e-commerce interface.</p>
...
export default {
    ...
    setup() {
        ...
        goToGitHub() {
            window.location.href = 'https://github.com/camilio77/proyectoWeb';
        },
    }
}
</script>
