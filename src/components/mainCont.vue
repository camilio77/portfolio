<template>
    <div class="all">
        <div class="ey">
            <div class="content">
                <h2>Hi, i'm Camilo Serrano</h2>
                <h2>Hi, i'm Camilo Serrano</h2>
                <h1>Hi, i'm Camilo Serrano</h1>
            </div>
...
.tilt-shaking {
    animation: tilt-shaking 1s ease-in-out;
